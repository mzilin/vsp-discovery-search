# Video Streaming Platform - Search Service


## Introduction

The `Search Service` is an integral component of the `Video Streaming Platform`, responsible for user creation, validation, updates and deletion.
